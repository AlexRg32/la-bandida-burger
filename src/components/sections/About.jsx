...
const About = () => {
    return (
        <section id="about" className="relative bg-brand-bgMain min-h-[80vh] flex items-center overflow-hidden py-24 scroll-mt-32">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-2 lg:order-1 text-center lg:text-left space-y-8">
                        ...
                        <div className="space-y-6 text-gray-400 text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 animate-fade-in-up delay-200">
                            <p>
                                <span className="text-brand-burgundy font-bold">LA BANDIDA</span> no nació en una sala de juntas. Nació del hambre. Hambre de verdad, de mancharse las manos, de dejar atrás las hamburguesas mediocres que prometen mucho y no saben a nada.
                            </p>
                            <p>
                            ...
                            <p className="font-display text-2xl text-brand-gold pt-4">
                                #NOBULLSHIT
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="order-1 lg:order-2 relative flex justify-center">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-brand-burgundy/10 blur-[100px] rounded-full"></div>
