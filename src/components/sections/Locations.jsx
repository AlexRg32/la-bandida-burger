...
const Locations = () => {
    return (
        <section id="locations" className="py-24 relative bg-brand-bgSection overflow-hidden scroll-mt-32">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-brand-bgMain via-brand-bgMain/80 to-transparent z-10"></div>

            <div className="container mx-auto px-4 relative z-20">
                <div className="text-center mb-16 reveal-zoom">
                    <span className="text-brand-gold text-sm font-bold tracking-widest uppercase block mb-2">Visítanos</span>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-brand-bgCard/80 backdrop-blur-md p-8 rounded-2xl border border-white/10 hover:border-brand-burgundy/50 transition-all hover:transform hover:-translate-y-2 group reveal-up">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="space-y-2 text-gray-400 font-body text-sm">
                                <p className="text-white font-bold mb-1 flex items-center gap-2">
                                    <Navigation className="w-4 h-4 text-brand-gold" /> DIRECCIÓN
                                </p>
                            ...
                            <div className="space-y-2 text-gray-400 font-body text-sm">
                                <p className="text-white font-bold mb-1 flex items-center gap-2">
                                    <Clock className="w-4 h-4 text-brand-gold" /> HORARIO
                                </p>
                            ...
                            <div className="space-y-2 text-gray-400 font-body text-sm">
                                <p className="text-white font-bold mb-1 flex items-center gap-2">
                                    <Phone className="w-4 h-4 text-brand-gold" /> CONTACTO
                                </p>
                        ...
                        <div className="mt-8 pt-8 border-t border-white/10 flex justify-center">
                            <button className="px-8 py-3 bg-white text-black font-display tracking-wider rounded hover:bg-brand-burgundy hover:text-white transition-all duration-300 transform hover:scale-105 shadow-xl">
                                CÓMO LLEGAR
                            </button>
                        </div>
                    </div>
